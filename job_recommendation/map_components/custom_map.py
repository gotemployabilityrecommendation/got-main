...
class CustomMap:
    ...
    def get_state_and_map_data_with_jss(self, user_state, filter_jss="", height=350, width=200, zoom=None, opacity=None):
        '''
    ...
    def get_permanent_address_map_data_jss(self, lat, lon, radius=25, filter_jss="", height=380, width=200, zoom=None, opacity=None):
